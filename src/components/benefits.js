  ...
  return (
    <section id="benefits">
      <div className="container d-flex flex-column  flex-lg-row justify-content-lg-between align-items-center">
        ...
        <div className="benefit d-flex flex-column  flex-lg-row align-items-center">
          <img src={Chart}></img>
          <p className="text-center text-lg-left">Постоянно растущее число успешно выполненных проектов</p>
        </div>
        <div className="benefit d-flex flex-column  flex-lg-row align-items-center">
          <img src={Form}></img>
          <p className="text-center text-lg-left">Подбор оборудования в проектируемых и вновь возводимых объектах</p>
        </div>
      </div>
    </section>
  );
