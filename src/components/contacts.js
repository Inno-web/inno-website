      ...
      <div className="row d-flex align-items-center">
        <div className="form-container pt-5 pb-4 col-lg-6 col-12 d-flex flex-column">
          ...
          <Form className="d-flex flex-column justify-content-center container ">
            ...
            <Form.Group className="mt-4" controlId="formBasicEmail">
              ...
              <Form.Control size="lg" type="email" placeholder="expample@gmail.com" />
            </Form.Group>
        ...
        <div className="information col-lg-6 col-12 d-flex flex-column pl-lg-5 pt-5 pt-lg-0">
          <div>
            ...
            <p>
              Московская обл. г Раменское ул. Сосновый Бор, 1к1
            </p>
          </div>
          <div>
            <h4>
          ...
          <div className="w-100" >
            <iframe className="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2256.0326017145117!2d38.17457131592332!3d55.56663108050397!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x414abffc4730c98b%3A0xb39e239e3af95973!2z0YPQuy4g0KHQvtGB0L3QvtCy0YvQuSDQkdC-0YAsIDEsINCg0LDQvNC10L3RgdC60L7QtSwg0JzQvtGB0LrQvtCy0YHQutCw0Y8g0L7QsdC7Liwg0KDQvtGB0YHQuNGPLCAxNDAxMDI!5e0!3m2!1sru!2suk!4v1577468036487!5m2!1sru!2suk" width="" height="" frameborder="0" style={{border:"0"}} allowfullscreen=""></iframe>
          </div>
        </div>
      </div>
    </section>
